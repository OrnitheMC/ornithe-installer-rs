...
import net.ornithemc.flap.lib.gson.GsonBuilder;
import net.ornithemc.flap.lib.gson.annotations.SerializedName;
import org.apache.logging.log4j.core.LoggerContext;
import org.apache.logging.log4j.core.config.Configurator;
import org.apache.logging.log4j.core.config.builder.api.ConfigurationBuilderFactory;

public class ServerLauncher {
	private static LoggerContext getLoggerCtx() {
		var builder = ConfigurationBuilderFactory.newConfigurationBuilder();
		var config = builder.add(
						builder.newAppender("SysOut", "Console").addAttribute("target", "SYSTEM_OUT")
